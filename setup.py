...
setup(
  ...
  packages = find_packages(exclude=['test']),   # Chose the same as "name"
  ...
  download_url = 'https://github.com/praKhr/FirestoreExtractor/archive/v_01.tar.gz',    # I explain this later on
